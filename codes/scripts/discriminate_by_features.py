...
#periodPI_list = np.load('TrainingData/PeriodPI_Len66_Dim%s_Tau%s_Pix%s_Spd_%s.npy' %(embed_dim, tau, pixels, spread))
#periodPI_list = periodPI_list[Ind]
#feature_list = [PI_list, period_list, periodPI_list]
#feature_name_list = ['PI', 'period', 'periodPI']
