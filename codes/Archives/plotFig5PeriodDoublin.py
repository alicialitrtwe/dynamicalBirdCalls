...
#X = np.load('/Users/Alicia/Desktop/BirdCallProject/Freq_20_10000/filteredCalls/RedRas3600_110615-DC-10.npy')
...
#plt.show()
fig.savefig('/Users/Alicia/AnacondaProjects/CurrentProject/PlotPaper/Fig5CloseReturnPlot.svg', dpi=300, bbox_inches='tight', transparent=True)Z